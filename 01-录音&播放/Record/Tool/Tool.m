...
+ (NSString *)creatPCMDataFileName {
    ...
    NSString *pathString = [NSString stringWithFormat:@"%@/RecordPCM", [Tool getLibraryCachesPath]];
...
+ (NSString *)creatYUVDataFileName {
    ...
    NSString *pathString = [NSString stringWithFormat:@"%@/RecordYUV", [Tool getLibraryCachesPath]];
    NSFileManager *fileManager= [NSFileManager defaultManager];
    //创建文件夹
    if(![fileManager fileExistsAtPath:pathString]) {
        [fileManager createDirectoryAtPath:pathString withIntermediateDirectories:YES attributes:nil error:nil];
...
+ (NSString *)fetchPCMFilePath {
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSString *pcmComponent = [[Tool getLibraryCachesPath] stringByAppendingPathComponent:@"RecordPCM"];
...
+ (NSString *)fetchYUVFilePath {
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSString *yuvComponent = [[Tool getLibraryCachesPath] stringByAppendingPathComponent:@"RecordYUV"];
